...
//   user: 'lyncjosu@gmail.com',               // Your GMail account used to send emails
//   pass: 'wvwokyojuydrfrgy'             // Application-specific password
//                                         // Send back to yourself;
...
router.use(unless(['/home', '/image', '/setPassword', '/forgotPassword', '/checkuser', '/checkemail', '/resetPassword', '/login', '/register', '/routes/image', '/routes/upload', '/routes/branch', '/routes/transferpipelinejobs', '/routes/regcoll', '/routes/pipelinejobs'], auth))
                ...
                connection.query('select * from usertype where Type = ?', req.body.user, (err, type) => {
                    ...
                    connection.query('INSERT INTO user set ?', [userdata], (err) => {
                        ...
                        let mailOptions = {
                            ...
                            text: "http://localhost:4200/Setpassword/" + token
                        }
