...
@Component({
  selector: 'app-college-employerlist',
  templateUrl: './college-employerlist.component.html',
  styleUrls: ['./college-employerlist.component.scss']
})
export class CollegeEmployerlistComponent implements OnInit {
